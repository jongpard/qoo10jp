...
환경변수(예시)
 SLACK_WEBHOOK_URL=...
 SLACK_TRANSLATE_JA2KO=1                 # 번역 사용 (없으면 번역줄 생략)
 GDRIVE_FOLDER_ID=...                    # 구글 드라이브 폴더
 GOOGLE_SERVICE_ACCOUNT_JSON=...         # (선호) 서비스계정 JSON(문자열 또는 b64)
 또는 GOOGLE_CLIENT_ID/SECRET/REFRESH_TOKEN  # OAuth 대안
"""
